...
<body>
<form action ="<%=request.getContextPath()%>/RetailBankController?action=login" method="post">
<div class="login">
    <input type="text" placeholder="Username" name="username" required pattern="[a-zA-Z0-9]+">  
    <input type="password" placeholder="password" name="password" required pattern="[a-zA-Z0-9]+">
    <!-- (?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$> -->  
